...
- Untuk MA Crossover, BUY atau SELL hanya muncul saat terjadi crossover SMA20 dan SMA50.
...
def generate_deterministic_explanation(analysis_result: dict[str, Any]) -> str:
    ...
    return (
        ...
        f"Evaluasi indikator terbaik: Directional Accuracy {accuracy}, Hit Rate {hit_rate}, "
